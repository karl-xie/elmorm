...
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 25).
...
yystate(29, [10|Ics], Line, Tlen, _, _) ->
    yystate(29, Ics, Line+1, Tlen+1, 5, Tlen);
...
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
...
yystate(25, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
yystate(25, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(25, Ics, Line, Tlen+1, Action, Alen);
...
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 9).
yyaction_0(TokenChars, TokenLen, TokenLine) ->
     { token, { name, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_1/2}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, keyword_or_var (TokenChars, TokenLine) } .

-compile({inline,yyaction_2/3}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 11).
yyaction_2(TokenChars, TokenLen, TokenLine) ->
     { token, { string, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_3/3}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 12).
yyaction_3(TokenChars, TokenLen, TokenLine) ->
     { token, { string, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_4/2}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 13).
yyaction_4(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_5/0}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 14).
yyaction_5() ->
     skip_token .

-compile({inline,yyaction_6/2}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 15).
yyaction_6(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_7/2}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 16).
yyaction_7(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_8/2}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 17).
yyaction_8(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, hex_to_int (TokenChars) } } .

-compile({inline,yyaction_9/1}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 18).
yyaction_9(TokenLine) ->
     { token, { qualifier, TokenLine, "@@" } } .

-compile({inline,yyaction_10/0}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 19).
yyaction_10() ->
     skip_token .

-compile({inline,yyaction_11/0}).
-file("f:/github/elmorm/src/elmorm_scanner.xrl", 20).
yyaction_11() ->
     skip_token .
